...
12. Cố gắng thêm các từ tuổi trẻ hay sử dụng khi đang trò chuyện và tâm sự với nhau như: uk, đc, òm, ừm, hủm, iu, cmm, dcm, chs, vs, chx, j, bri, bt, vv, gay, trùm, uiiii, hài dón, adu, vip, bede,vc, hết cứu, ko, hong, kh, ao that day,... các kí tự như :)), =)), :3 , :P, >:(,...
